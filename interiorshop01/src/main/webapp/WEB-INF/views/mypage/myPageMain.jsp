...
<table class="tbl_edit01" style="font-size:14px; font-weight:bold;">
		<tbody align=center >
			<tr class="mp_short" >
				<td>주문번호</td>
				<td>주문일자</td>
...
<table class="tbl_edit01"><!-- border=0 width=100% cellpadding=10 cellspacing=10 -->
  <tr >
    <td class="mp_short">
	   이메일
   </td>
  ...
  <tr>
    ...
    <td>
	   <strong>${memberInfo.cashback_point } P</strong>
   </td>
  </tr>
  <tr>
    <td class=mp_short>
